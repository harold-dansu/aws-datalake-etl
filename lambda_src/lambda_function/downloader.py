...
client_id = 'XXXXXXXXXXXXXXXXXXXXXXXXXX'    #cognito app id 
pool_id = 'us-west-2_ABCDeFg'             #cognito user pool id
...
def get_streaming_data(token):
	...
	REQUEST_URL = 'https://api.blisspointmedia.com/admin/pacing?company=blank&start=' +\
...
def get_linear_data(token):
	...
	REQUEST_URL = 'https://api.blisspointmedia.com/linear/estimates?company=blank&week=' + start_date 
